  ...
  return (
    ...
    >
      <Link to={`/visualizar/${catalog.id}?category=${catalog.categoryId}`}>
        <div className="overflow-hidden rounded-lg bg-brown-light shadow-gold hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="p-4 sm:p-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto px-4 py-2 bg-gold text-brown rounded-lg hover:bg-gold-light transition-colors duration-300 flex items-center justify-center gap-2"
            >
